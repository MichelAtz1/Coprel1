...
public class GerenciarLocacoes extends AppCompatActivity
    ...
    private ListView listViewPostes, listViewDoc, listViewVisita; //listViewVegetacao ,
    ...
    private void inflaListaVegetacaoComIdLocacao() {
        ...
        if (linhas.moveToFirst()) {
            do {
                String idPoste = linhas.getString(0);
                String texto = " Poste - " + linhas.getString(1);
            ...
            if (linhas.moveToFirst()) {
                do {
                    ...
                    if (valorNulo.equals("1")) {
                        ...
                        String estruturaMT = String.format("%-25s", textoFinalEstruturaPrimaria);
                        String estruturaBT = String.format("%-20s", textoFinalEstruturaSecundaria);

                        texto = (numero + " " + coordenadaX + " " + coordenadaY + " " + alturaCapacidade + " " + estruturaMT + " " + estruturaBT + " " + String.format("%-15s", estai) + " " + bloco + " " + iluminacaoPublica + " " + String.format("%-13s", tlSemelhantes) + " " + solo + " " + acesso + " " + vidaUtil + " \n");
                    }
            ...
            if (linhas.moveToFirst()) {
                do {
                    ...
                    if (linhas2.moveToFirst()) {
                        do {
                            texto2 = (id + " " + linhas2.getString(1) + " " + String.format("%-3s", linhas2.getString(4)) + " " + String.format("%-4s", linhas2.getString(5)) +" " + String.format("%-1s", linhas2.getString(3)) +" " + String.format("%-1s", linhas2.getString(2)) +" \n");
                        ...
                        if (linhas3.moveToFirst() && linhas3.getCount() > 0) {
                            ...
                            do {
                                ...
                                if (imagemBase64 != null) {
                                    ...
                                    ByteArrayOutputStream stream3 = new ByteArrayOutputStream();
                                    Bitmap imagemBitmap = decodeBase64(imagemBase64);
                                    Bitmap novoTamanho = Bitmap.createScaledBitmap(imagemBitmap, (int) (imagemBitmap.getWidth() * 0.55), (int) (imagemBitmap.getHeight() * 0.55), true);//tava 0.68
                                    novoTamanho.compress(Bitmap.CompressFormat.JPEG, 100, stream3);
                                    Image myImg3 = Image.getInstance(stream3.toByteArray());
...
*/
        ...
        if(linhas1.getCount() != 0) {
            ...
            if (linhas1.moveToFirst()) {
                ...
                do {
                    ...
                    Paragraph paragrafo1 = new Paragraph(" Poste: "+linhas1.getString(2));
        ...
        if(linhas1.getCount() != 0) {
            ...
            if (linhas1.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph(" Relatório Fotográfico - Visita Técnica");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
    ...
    public void createPdfImagens() throws IOException, DocumentException {
        ...
        Cursor linhas1 = db.rawQuery("SELECT ID, IMAGEM FROM " + TABELADOCUMENTO + " WHERE IDLOCACAO = " + idLocacao + " AND NOMEDOCUMENTO = 'Ambiental';", null);

        if(linhas1.getCount() != 0) {
            // Criando o arquivo PDF, com o n da nota como nome do arquivo
            pdfFile = new File(docsFolder2.getAbsolutePath(), notaLocacao + "_Ambiental.pdf");
            OutputStream output = new FileOutputStream(pdfFile);
            Document document = new Document(PageSize.A4, 0, 0, 0, 0);
            PdfWriter.getInstance(document, output);

            document.addTitle("Ambiental");
            int ARSP = 0;
            ...
            if (linhas1.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Ambiental\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        if(linhas2.getCount() != 0) {
            ...
            if (linhas2.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Autorização de Passagem\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        if(linhas3.getCount() != 0) {
            ...
            if (linhas3.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Croqui\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        if(linhas4.getCount() != 0) {
            ...
            if (linhas4.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Escritura ou Contrato\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        if(linhas5.getCount() != 0) {
            ...
            if (linhas5.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Levantamento de Carga\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        Cursor linhas6 = db.rawQuery("SELECT ID, IMAGEM FROM " + TABELADOCUMENTO + " WHERE IDLOCACAO = " + idLocacao + " AND NOMEDOCUMENTO = 'Documento Cliente';", null);

        if(linhas6.getCount() != 0) {
            // Criando o arquivo PDF, com o n da nota como nome do arquivo
            pdfFile = new File(docsFolder2.getAbsolutePath(), notaLocacao + "_Documento Cliente.pdf");
            OutputStream output = new FileOutputStream(pdfFile);
            Document document = new Document(PageSize.A4, 0, 0, 0, 0);
            PdfWriter.getInstance(document, output);

            document.addTitle("Documento Cliente");
            if (linhas6.moveToFirst()) {
                ...
                do {
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Documento Cliente\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
        ...
        Cursor linhas7 = db.rawQuery("SELECT ID, IMAGEM FROM " + TABELADOCUMENTO + " WHERE IDLOCACAO = " + idLocacao + " AND NOMEDOCUMENTO = 'Termo Retirada de Rede';", null);

        if(linhas7.getCount() != 0) {
            // Criando o arquivo PDF, com o n da nota como nome do arquivo
            pdfFile = new File(docsFolder2.getAbsolutePath(), notaLocacao + "_Termo Retirada de Rede.pdf");
            OutputStream output = new FileOutputStream(pdfFile);
            Document document = new Document(PageSize.A4, 0, 0, 0, 0);
            PdfWriter.getInstance(document, output);

            document.addTitle("Termo Retirada de Rede");
            if (linhas7.moveToFirst()) {
                document.open();
                do {
                    ByteArrayOutputStream stream = new ByteArrayOutputStream();
                    Bitmap bitmap = BitmapFactory.decodeResource(getBaseContext().getResources(), R.drawable.moldecima);
                    ...
                    Font titleFont = new Font(Font.FontFamily.COURIER, 20, Font.BOLD);
                    Paragraph paragrafo1 = new Paragraph("RELATÓRIO FOTOGRÁFICO - Termo Retirada de Rede\n");
                    paragrafo1.setFont(titleFont);
                    paragrafo1.setAlignment(Element.ALIGN_CENTER);
                    document.add(paragrafo1);
                    ...
                    byte[] imagemBase64 = linhas7.getBlob(1);
...
*/
    ...
    private void createPdfDadosConsumidores() throws IOException, DocumentException {
        String idPoste = "", conferiTexto = "", textoDadosEquipamento = "", id = "";
        ...
        if(linhas.getCount() != 0) {
            pdfFile = new File(docsFolder2.getAbsolutePath(), notaLocacao + "_Dados Consumidores.pdf");
            OutputStream output = new FileOutputStream(pdfFile);
            Document document = new Document(PageSize.A4, 0, 0, 0, 0);
            PdfWriter.getInstance(document, output);

            document.addTitle("Consumidores");
            document.open();
            ...
            if (linhas.moveToFirst()) {
                do {
                    ...
                    if (linhas2.moveToFirst()) {
                        do {
                            //Log.d("teste","cont: "+contador2);
                            if(contador2 % 2 != 0 ){//|| contador2 == 1

                                ByteArrayOutputStream stream = new ByteArrayOutputStream();
                                Bitmap bitmap = BitmapFactory.decodeResource(getBaseContext().getResources(), R.drawable.moldecima);
                                Bitmap tamanhoReduzidoParaCima = Bitmap.createScaledBitmap(bitmap, 589, 70, true);
                                tamanhoReduzidoParaCima.compress(Bitmap.CompressFormat.JPEG, 100, stream);
                                Image myImg = Image.getInstance(stream.toByteArray());
                                myImg.setAlignment(Image.MIDDLE);
                                document.add(myImg);

                                Paragraph paragrafo1 = new Paragraph("MEDIDORES\n\n\n");
                                paragrafo1.setAlignment(Element.ALIGN_CENTER);
                                document.add(paragrafo1);
                                ...
                                String lado ="";
                                if(linhas2.getString(1).equals("E")){
                                    lado = "Esquerdo";
                                }else if(linhas2.getString(1).equals("D")){
                                    lado = "Direito";
                                }else{
                                    lado ="";
                                }

                                cell = new PdfPCell(new Phrase("POSTE: "+id+" - LADO: "+ lado));
                                BaseColor color = WebColors.getRGBColor("#CCC");
                                cell.setBackgroundColor(color);
                                cell.setPadding(5);
                                cell.setColspan(3);
                                table.addCell(cell);

                                table.addCell("Medidor: "+linhas2.getString(6));
                                String fase = "";
                                if(linhas2.getString(7).equals("Faseamento")){
                                    fase = "";
                                }else{
                                    fase = linhas2.getString(7);
                                }
                                table.addCell("Faseamento: "+fase);

                                String ramal = "";
                                if(linhas2.getString(4).equals("Ramal")){
                                    ramal = "";
                                }else{
                                    ramal = linhas2.getString(4);
                                }
                                table.addCell("Ramal: "+ramal );

                                table.addCell("Distância Ramal: "+ linhas2.getString(8));


                                String localizacao = "";
                                if(linhas2.getString(9).equals("Localização")){
                                    localizacao = "";
                                }else{
                                    localizacao = linhas2.getString(9);
                                }
                                table.addCell("Localização: "+localizacao);
                                String tipoMedicao = "";
                                if(linhas2.getString(10).equals("Selecione o Tipo da Medição")){
                                    tipoMedicao = "";
                                }else{
                                    tipoMedicao = linhas2.getString(10);
                                }
                                table.addCell("Medição: "+tipoMedicao);

                                cell = new PdfPCell(new Phrase("DADOS DO MEDIDOR"));
                                cell.setPadding(10);
                                cell.setBackgroundColor(color);
                                ...
                                String tipo = "";
                                if(linhas2.getString(11).equals("Tipo")){
                                    tipo = "";
                                }else{
                                    tipo = linhas2.getString(11);
                                }
                                table.addCell("Tipo: "+tipo);
                                String marca = "";
                                if(linhas2.getString(12).equals("Marca")){
                                    marca = "";
                                }else{
                                    marca = linhas2.getString(12);
                                }
                                table.addCell("Marca: "+marca);
                                String modelo = "";
                                if(linhas2.getString(13).equals("<- Selecionar Marca")){
                                    modelo = "";
                                }else{
                                    modelo = linhas2.getString(13);
                                }
                                table.addCell("Modelo: "+modelo);

                                table.addCell("Corrente Nominal: "+linhas2.getString(14));
                                table.addCell("N° Fases: "+linhas2.getString(15));
                                table.addCell("N° Elemento: "+linhas2.getString(16));

                                table.addCell("N° Fios: "+linhas2.getString(18));
                                table.addCell("Frequencia(hz): "+linhas2.getString(17));
                                table.addCell("Kd/Watt: "+linhas2.getString(19));

                                table.addCell("Classe: "+linhas2.getString(3));
                                String digitos = "";
                                if(linhas2.getString(20).equals("Digitos")){
                                    digitos = "";
                                }else{
                                    digitos = linhas2.getString(20);
                                }
                                table.addCell("N° Digitos: "+digitos);
                                table.addCell("Fator Multiplicador: "+linhas2.getString(21));

                                table.addCell("Fabricação: "+linhas2.getString(22));
                                cell = new PdfPCell(new Phrase("Leitura Kwh: "+linhas2.getString(23)));
                                cell.setColspan(2);
                                table.addCell(cell);

                                table.addCell("Leitura Kvarh: "+linhas2.getString(24));
                                cell = new PdfPCell(new Phrase("Disjuntor: "+linhas2.getString(25)));
                                cell.setColspan(2);
                                table.addCell(cell);
...
*/
                                ByteArrayOutputStream stream2 = new ByteArrayOutputStream();
                                Bitmap bitmap2 = BitmapFactory.decodeResource(getBaseContext().getResources(), R.drawable.moldebaixo2);
                                Bitmap tamanhoReduzidoParaBaixo = Bitmap.createScaledBitmap(bitmap2, 589, 70, true);
                                tamanhoReduzidoParaBaixo.compress(Bitmap.CompressFormat.JPEG, 100, stream2);
                                Image myImg2 = Image.getInstance(stream2.toByteArray());
                                myImg2.setAbsolutePosition(3, 3);
                                document.add(myImg2);
