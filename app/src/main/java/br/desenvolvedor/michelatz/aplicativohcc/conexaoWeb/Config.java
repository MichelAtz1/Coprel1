...
public class Config {
    ...
    //Servidor real
    //public static final String URL_ADD_IMAGEM ="http://idealizaweb.com.br/dadosCoprel/inseriFotoServidor.php";
    //public static final String URL_ADD_TXT ="http://idealizaweb.com.br/dadosCoprel/inseriTxtServidor.php";

    public static final String URL_ADD_IMAGEM = "http://aplicativohcc.16mb.com/dadosCoprel/inseriFotoServidor.php";
    public static final String URL_ADD_TXT = "http://aplicativohcc.16mb.com/dadosCoprel/inseriTxtServidor.php";
